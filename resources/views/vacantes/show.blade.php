    ...
    <div class="mt-10 mb-20 md:flex items-start">
        <div class="md:w-3/5">
            ...
            @foreach ($arraySkills as $skill)
                <p class="inline-block text-gray-700 my-2 border border-gray-400 py-2 px-8 rounded">
                    {{ $skill }}
                </p>
            @endforeach
                <a href="/storage/vacantes/{{ $vacante->imagen }}" data-lightbox="imagen" data-title="Vacante {{ $vacante->titulo }}">
                    <img src="/storage/vacantes/{{ $vacante->imagen }}" alt="{{ $vacante->titulo }}" class="w-40 mt-5">
                </a>
