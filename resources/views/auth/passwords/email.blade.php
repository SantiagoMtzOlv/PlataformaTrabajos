    ...
    <div class="flex flex-wrap justify-center">
        <div class="w-full max-w-sm">
            <div class="flex flex-col break-words bg-white border-2 shadow-md mt-20">
                <div class="bg-gray-300 text-gray-600 uppercase text-center py-3 px-6 mb-0">
                    {{ __('Reset Password') }}
                </div>
                <form method="POST" action="{{ route('password.email') }}" class="py-10 px-5" novalidate>
                    ...
                    @if (session('status'))
                    <span class="bg-green-100 border-l-4 border-green-500 text-green-700 p-3 w-full my-5 rounded text-sm mx-3" role="alert">
                    ...
                    <div class="flex flex-wrap mb-6 mt-6">
                        <label for="email" class="block text-gray-700 text-sm mb-2">{{ __('E-Mail Address') }}</label>
                            ...
                            @error('email')
                                <span class="bg-red-100 border-l-4 border-red-500 text-red-700 p-3 w-full mt-5 rounded text-sm" role="alert">
                    ...
                    <div class="flex flex-wrap">
                        <button
                            type="submit"
                            class="bg-teal-500 w-full hover:bg-teal-700 text-gray-100 p-3 focus:outline-none focus:shadow-outline uppercase font-bold rounded text-sm">
