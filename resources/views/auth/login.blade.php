            ...
            <div class="flex flex-col break-words bg-white border-2 shadow-md mt-20">
                ...
                <form method="POST" action="{{ route('login') }}" class="py-10 px-5" novalidate>
                    ...
                    <div class="flex flex-wrap">
                        <button
                            type="submit"
                            class="bg-teal-500 w-full hover:bg-teal-700 text-gray-100 p-3 focus:outline-none focus:shadow-outline uppercase font-bold rounded">
                            {{ __('Login') }}
                        </button>

                        @if (Route::has('password.request'))
                            <a class="text-sm text-gray-500 mt-5 w-full text-center" href="{{ route('password.request') }}">
